...
/**
 * Regression test for https://github.com/badlogic/pizza/issues/3303
 *
...
describe("issue #3303 nested .gitignore rules leak into sibling directories", () => {
	...
	describe("flat sibling case", () => {
		beforeEach(() => {
			tempRoot = mkdtempSync(join(tmpdir(), "pizza-3303-flat-"));
	...
	describe("deeply nested case", () => {
		beforeEach(() => {
			tempRoot = mkdtempSync(join(tmpdir(), "pizza-3303-deep-"));
