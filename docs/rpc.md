...
**Note for Node.js/TypeScript users**: If you're building a Node.js application, consider using `SessionFacade` directly from `@mariozechner/pi-coding-agent` instead of spawning a subprocess. See [`docs/sdk.md`](./sdk.md) for the API. For a subprocess-based TypeScript client, see [`src/modes/rpc/rpc-client.ts`](../src/modes/rpc/rpc-client.ts).
