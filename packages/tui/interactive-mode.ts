...
import { createLocalBashOperations, type BashOperations } from "../../src/core/tools/bash.js";
...
import type { ApprovalHandler, IntentClassification } from "../../src/core/intent/types.js";
...
import { FooterDataProvider, type ReadonlyFooterDataProvider } from "../../src/core/footer-data-provider.js";
...
import { defaultModelPerProvider, findExactModelReferenceMatch } from "../../src/core/model-resolver.js";
import { DefaultPackageManager } from "../../src/core/package-manager.js";
import { GoalProjection } from "../../src/core/projection/goal-projection.js";
import { buildRecentTaskHistory, TASK_HISTORY_EVENT_TYPES } from "../../src/core/projection/task-history.js";
import type { ResourceDiagnostic, ResourceLoader } from "../../src/core/resource-loader.js";
import { formatMissingSessionCwdPrompt, MissingSessionCwdError } from "../../src/core/session-cwd.js";
import { type SessionEntry, type SessionTreeNode } from "../../src/core/types/session-types.js";
import { listWorkspaceSessions, listAllSessions } from "../../src/core/session-listing.js";
import { BUILTIN_SLASH_COMMANDS } from "../../src/core/slash-commands.js";
import type { SourceInfo } from "../../src/core/source-info.js";
import type { TruncationResult } from "../../src/core/tools/truncate.js";
import { copyToClipboard } from "../../src/utils/clipboard.js";
import { extensionForImageMimeType, readClipboardImage } from "../../src/utils/clipboard-image.js";
...
export class InteractiveMode {
	...
	private getExtensionSessionManager() {
		const { EventStoreExtensionSessionManager } = require("../../src/core/extensions/session-context.js") as typeof import("../../src/core/extensions/session-context.js");
