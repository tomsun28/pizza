...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `pizza` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "pizza";
	 *
...
export interface ExtensionContext {
	...
	/** Gracefully shutdown Pizza and exit. Available in all contexts. */
	shutdown(): void;
...
/** Configuration for registering a provider via pizza.registerProvider(). */
...
export type ExtensionFactory = (pizza: ExtensionAPI) => void | Promise<void>;
...
/**
 * Action implementations for pizza.* API methods.
