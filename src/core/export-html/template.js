    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="pizza-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="pizza-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'pizza-share:v1:sidebar-width';
