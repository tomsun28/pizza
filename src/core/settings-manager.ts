...
export class SettingsManager {
	...
	getClearOnShrink(): boolean {
		...
		return (process.env.PIZZA_CLEAR_ON_SHRINK ?? process.env.PI_CLEAR_ON_SHRINK) === "1";
	}
	...
	getShowHardwareCursor(): boolean {
		return this.settings.showHardwareCursor ?? (process.env.PIZZA_HARDWARE_CURSOR ?? process.env.PI_HARDWARE_CURSOR) === "1";
	}
