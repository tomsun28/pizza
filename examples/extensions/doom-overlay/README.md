...
Play DOOM as an overlay in pizza. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
pizza --extension ./examples/extensions/doom-overlay
```
...
- [pizza-doom](https://github.com/badlogic/pizza-doom) for the original Pizza integration
