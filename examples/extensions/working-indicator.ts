 ...
 * working indicator shown while Pizza is streaming a response.
 *
 * Usage:
 *   pizza --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore Pizza's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "pizza";
...
export default function (pizza: ExtensionAPI) {
	...
	pizza.registerCommand("working-indicator", {
